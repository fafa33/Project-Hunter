...
def test_all_checks_green_ignores_legacy_governance_pending_marker() -> None:
    """DFF-032: canonical direct evidence owns the decision, not a derived status."""
    ...
    assert report.derived is WorkflowState.MERGE_READY
    assert readiness.GOVERNANCE_CONTEXT not in established[WorkflowState.ALL_CHECKS_GREEN].detail
