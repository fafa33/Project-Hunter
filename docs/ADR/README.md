...
| [0031](0031-ai-context-prompt-intelligence-foundation.md) | AI Context and Prompt Intelligence Foundation | Proposed | Provider-independent execution intent, exact context resolution and selection, observable missingness/omission, deterministic budgeting and prompt artifacts, conditional exact pre-model reconstruction, proposal-only authority, Evidence Intelligence migration, and zero-LLM governance preservation |
