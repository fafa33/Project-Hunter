...
| [0035](0035-evidence-intelligence-response-validator-boundary.md) | Evidence Intelligence ResponseValidator Boundary | Accepted base; Proposed amendment | Accepted separate Evidence Intelligence `ResponseValidator`, dedicated validation-profile authority, trusted allocation, validation-time Source Handling, attestations, durable-acceptance chronology, strict-known replay, correction/CAS, closed vocabulary, and downstream stop boundary. Phase A is implemented but unactivated under Issue #332. ADPR-0011 / Issue #338 / Draft PR #339 propose a not-yet-accepted amendment for protected transient capture/consumption, non-durable transfer, ADR 0035-owned restart-surviving one-event reservation, refusal semantics, and Phase-A-compatible fresh-capture lineage. PR #335 remains blocked pending amendment acceptance and separate implementation authorization; no runtime, terminal persistence, provider, promotion, or production activation is added by drafting. |
