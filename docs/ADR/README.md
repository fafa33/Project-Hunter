...
| [0028](0028-evidence-assembly-supporting-authorities.md) | Canonical Evidence Assembly Supporting Authorities | Proposed | Ownership, record family, persistence, versioning, correction, provenance, strict-known replay, conflict, and amendment-governance semantics for Methodology Contract, Evidence Shape Registry, and Evidence Semantics authorities; narrow amendment to ADR 0025's ownership silence |
