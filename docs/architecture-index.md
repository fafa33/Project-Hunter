...
| [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) | [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | Ownership, persistence, versioning, correction, provenance, strict-known replay, conflict, and amendment-governance semantics for Methodology Contract (owned by `hunter.valuation_methodology`), Evidence Shape Registry, and Evidence Semantics (both owned by `hunter.evidence_assembly`) authorities; narrow amendments to ADR 0025's ownership silence and to ADR 0022 (additive `accepts_assembled_evidence` field on `ValuationMethodologySnapshot`) | Proposed, revision 2; drafted under Issue #191; resolved five independent-review `CHANGES REQUIRED` findings against revision 1; pending a second independent review round and acceptance; no implementation authorized |
...
| Issue #191 | [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | [PR #192](https://github.com/fafa33/Project-Hunter/pull/192) (Draft); implementation not yet created | Architecture preparation only; prerequisite for unblocking Issue #190; revision 2 resolves five independent-review `CHANGES REQUIRED` findings against revision 1; awaiting a second independent review round and acceptance before any implementation may begin |
