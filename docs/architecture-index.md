...
| [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | Canonical Evidence Assembly Supporting Authorities | READY_FOR_REVIEW | None material — revision 7 preserves the upstream semantic-input authority, corrects ADR 0025's conflicting Representation Continuity Proof ownership, and makes MethodologyEvidenceInputContract ownership/dependency boundaries explicit; independent review pending | not yet assigned |
...
| Issue #191 | [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | [PR #192](https://github.com/fafa33/Project-Hunter/pull/192) (Draft); implementation not yet created | Architecture preparation only; revision 7 preserves the canonical upstream semantic-input authority, corrects the ADR 0025 ownership conflict, and makes the MethodologyEvidenceInputContract boundary explicit; awaiting independent review and acceptance; Issue #190 remains blocked |
...
| Evidence | [ADPR-0002](architecture-records/ADPR-0002-disclosure-architecture-classification.md), [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | ADR 0025, [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | ADR 0028 revision 7 keeps `FundamentalEvidenceRecord` observation-only, preserves `hunter.evidence_semantic_inputs` as the sole upstream owner of immutable semantic-classification inputs, and corrects ADR 0025 so Representation Continuity Proof is produced only upstream. Evidence Semantics consumes only its strict-known `EvidenceSemanticInputRecord`; assembled records persist exact native, policy, semantic-input, and semantics lineage. Dependency direction is `value_capture → evidence_semantic_inputs → evidence_assembly`, with no reverse dependency. Issue #190 remains blocked. |
