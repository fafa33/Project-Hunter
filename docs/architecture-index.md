...
| [ADPR-0008](architecture-records/ADPR-0008-source-handling-classification-authority.md) | Source Handling Classification Authority | READY_FOR_REVIEW | None material to the ownership assignment; independent architecture audit has not yet been performed, and ADR 0033 cannot advance to acceptance until it is | not yet assigned |
