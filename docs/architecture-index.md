...
| Issue #191 | [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | [PR #192](https://github.com/fafa33/Project-Hunter/pull/192) (Draft); implementation not yet created | Architecture preparation only; revision 8 preserves the canonical upstream semantic-input authority, proposes the ADR 0025 ownership amendment for effect only upon ADR 0028 acceptance, and makes the MethodologyEvidenceInputContract boundary explicit; awaiting independent review and acceptance; Issue #190 remains blocked |
