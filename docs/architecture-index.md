...
| [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | AI Context and Prompt Intelligence Foundation | READY_FOR_REVIEW | Independent preparation audit must confirm this retrospective F-007 remediation before ADR 0031 resumes formal acceptance; implementation prerequisites remain deferred | not yet assigned |
...
| Issue #206 | [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Proposed) | [Draft PR #207](https://github.com/fafa33/Project-Hunter/pull/207); implementation not started | ADPR-0006 remediates F-007 and awaits independent preparation audit; ADR 0031 remains Proposed and no Phase 1 work is authorized |
...
| AI Context and Prompt Intelligence | [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Proposed) | Provider-independent pre-model foundation; Evidence Intelligence is the first narrow migration target; Governance Review remains deterministic and zero-LLM; independent preparation audit pending; no implementation authorized. |
