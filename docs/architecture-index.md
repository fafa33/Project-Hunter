...
| [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Proposed) | APPROVED | Not started or authorized | Second independent preparation audit passed for `7a64f54bf51fd9f81ee859f9ca63389e5938bdac`; ADR 0031 aligned to Option 7 at `12ac95d3582bf569fe76beb29c06a274133cf080`; renewed exact-pair ADR review remains required |
...
| Issue #206 | [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Proposed) | [Draft PR #207](https://github.com/fafa33/Project-Hunter/pull/207); implementation not started | ADPR-0006 is `APPROVED`; ADR 0031 is aligned to Option 7 and remains Proposed; F-FR-001 through F-FR-003 remediation requires renewed exact-pair review; no Phase 1 work is authorized |
...
| AI Context and Prompt Intelligence | [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Proposed) | Evidence Intelligence-specific provider-independent pre-model foundation; generic ownership is deferred until a second real consumer triggers a new ADPR/ADR; Governance Review remains deterministic and zero-LLM; formal ADR review pending; no implementation authorized. |
