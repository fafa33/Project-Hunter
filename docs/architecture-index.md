...
| [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | AI Context and Prompt Intelligence Foundation | READY_FOR_REVIEW | Second independent preparation audit reported PASS; ADR 0031 must align to the Evidence Intelligence-specific recommendation and complete formal review; implementation prerequisites remain deferred | not yet assigned |
...
| Issue #206 | [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Proposed) | [Draft PR #207](https://github.com/fafa33/Project-Hunter/pull/207); implementation not started | Second independent preparation audit reported PASS; ADR 0031 is aligned to its Evidence Intelligence-specific outcome and remains Proposed pending formal review; no Phase 1 work is authorized |
