...
| [ADPR-0007](architecture-records/ADPR-0007-project-agnostic-prompt-intelligence-core.md) | Project-Agnostic Prompt Intelligence Core | READY_FOR_REVIEW | Independent architecture review of the project-neutral boundary and evidence-gated admission rule remains; no concrete cross-project contract is asserted or implemented | repository owner-directed architecture work |
...
| [ADR 0032](ADR/0032-project-agnostic-prompt-intelligence-core.md) | [ADPR-0007](architecture-records/ADPR-0007-project-agnostic-prompt-intelligence-core.md) | Project-neutral ownership/dependency boundary and evidence-gated admission rule; no specific Hunter contract or external-project contract is declared shared | Proposed; ADPR-0007 is `READY_FOR_REVIEW`; independent architecture review remains; no runtime implementation or external-project integration authorized |
...
| Issue #237 | [ADPR-0007](architecture-records/ADPR-0007-project-agnostic-prompt-intelligence-core.md) | [ADR 0032](ADR/0032-project-agnostic-prompt-intelligence-core.md) (Proposed) | [PR #239](https://github.com/fafa33/Project-Hunter/pull/239); implementation not started | Boundary/admission architecture is `READY_FOR_REVIEW`; concrete shared-contract promotion is explicitly deferred pending independent consumer evidence |
...
| AI Context and Prompt Intelligence | [ADPR-0007](architecture-records/ADPR-0007-project-agnostic-prompt-intelligence-core.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Accepted); [ADR 0032](ADR/0032-project-agnostic-prompt-intelligence-core.md) (Proposed) | ADR 0031 remains authoritative for Hunter's concrete pre-model contracts. ADR 0032 proposes only a project-neutral boundary and evidence-gated admission rule; no external project is coupled to Hunter and no current Hunter contract is declared shared. |
