...
| AI Context and Prompt Intelligence | [ADPR-0006](architecture-records/ADPR-0006-ai-context-prompt-intelligence-foundation.md) | [ADR 0031](ADR/0031-ai-context-prompt-intelligence-foundation.md) (Accepted) | Evidence Intelligence-specific provider-independent pre-model foundation; generic ownership is deferred until a second real consumer triggers a new ADPR/ADR; Governance Review remains deterministic and zero-LLM; architecture accepted; no implementation authorized. |
