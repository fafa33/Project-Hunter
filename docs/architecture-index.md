...
| [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | Canonical Evidence Assembly Supporting Authorities | READY_FOR_REVIEW | Not yet independently reviewed; Open Questions OQ-001 (Methodology Contract scope) and OQ-002 (Evidence Semantics classification-authoring mechanism) remain unresolved | not yet assigned |
...
| [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) | [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | Ownership, persistence, versioning, correction, provenance, strict-known replay, conflict, and amendment-governance semantics for Methodology Contract, Evidence Shape Registry, and Evidence Semantics authorities; narrow amendment to ADR 0025's ownership silence | Proposed; drafted under Issue #191; pending independent review and acceptance; no implementation authorized |
...
| Issue #191 | [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | Draft PR recorded once opened; implementation not yet created | Architecture preparation only; prerequisite for unblocking Issue #190; awaiting independent review and acceptance before any implementation may begin |
