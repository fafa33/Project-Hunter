...
| [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | Canonical Evidence Assembly Supporting Authorities (revision 8 — canonical upstream semantic-input authority and conditional ownership-amendment proposal) | READY_FOR_REVIEW | not yet created | #191 (completed preparation; acceptance governed by #193; prerequisite for blocked #190) | [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | [PR #192](https://github.com/fafa33/Project-Hunter/pull/192) (Merged) | `89a2c2c9c2714aa2391c1fb3f26de5ab3e36eb32` | not yet assigned | not applicable | not applicable |
...
| [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | Canonical Evidence Assembly Supporting Authorities | READY_FOR_REVIEW | None material — revision 8 preserves the upstream semantic-input authority, proposes the ADR 0025 Representation Continuity Proof ownership amendment for effect only upon ADR 0028 acceptance, and makes MethodologyEvidenceInputContract ownership/dependency boundaries explicit; independent review pending under acceptance Issue #193 | not yet assigned |
...
| Issue #190 | not applicable | ADR 0025 | not yet created | `BLOCKED`: `CanonicalEvidenceAssemblyService` cannot be constructed with production collaborators until ADR 0028 is accepted and implemented under Issue #193; preparation was completed under Issue #191 and ADPR-0005; see `docs/ARCHITECTURE_AUDITS/issue-190-evidence-assembly-authority-gap.md` |
| Issue #191 / Issue #193 | [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | [PR #192](https://github.com/fafa33/Project-Hunter/pull/192) (Merged at `89a2c2c9c2714aa2391c1fb3f26de5ab3e36eb32`); implementation not yet created | Issue #191 completed architecture preparation; Issue #193 governs ADR acceptance; revision 8 preserves the canonical upstream semantic-input authority, proposes the ADR 0025 ownership amendment for effect only upon ADR 0028 acceptance, and makes the MethodologyEvidenceInputContract boundary explicit; acceptance pending; Issue #190 remains blocked |
...
| Evidence | [ADPR-0002](architecture-records/ADPR-0002-disclosure-architecture-classification.md), [ADPR-0005](architecture-records/ADPR-0005-evidence-assembly-supporting-authorities.md) | ADR 0025, [ADR 0028](ADR/0028-evidence-assembly-supporting-authorities.md) (Proposed) | ADR 0028 revision 8 keeps `FundamentalEvidenceRecord` observation-only, preserves `hunter.evidence_semantic_inputs` as the sole upstream owner of immutable semantic-classification inputs, and proposes that ADR 0025 state Representation Continuity Proof is produced only upstream upon acceptance. Evidence Semantics consumes only its strict-known `EvidenceSemanticInputRecord`; assembled records persist exact native, policy, semantic-input, and semantics lineage. Dependency direction is `value_capture → evidence_semantic_inputs → evidence_assembly`, with no reverse dependency. Issue #190 remains blocked. |
