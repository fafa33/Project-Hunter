...
| Issue #301 | [ADPR-0009](architecture-records/ADPR-0009-evidence-intelligence-model-adapter.md) | [ADR 0034](ADR/0034-evidence-intelligence-model-adapter-provider-attempt-boundary.md) (Accepted) | ADR acceptance contribution; implementation not yet created | Architecture: Accepted — ADR 0034 is binding. Implementation: not started and not activated; no runtime, provider, credential, `ResponseValidator`, or routing exists, and CO-01 through CO-23 remain unsatisfied future gates. Implementation requires a separate authorized lifecycle |
