...
| [ADPR-0008](architecture-records/ADPR-0008-source-handling-classification-authority.md) | [ADR 0033](ADR/0033-source-handling-classification-authority.md) (Accepted) | APPROVED | Not started or authorized | Independent architecture audit returned `PASS` / `READY_FOR_ADR`; repository owner accepted ADR 0033 on 2026-08-14. Acceptance is lifecycle-only and authorizes no runtime implementation. |
...
| [ADR 0033](ADR/0033-source-handling-classification-authority.md) | [ADPR-0008](architecture-records/ADPR-0008-source-handling-classification-authority.md) | Exclusive Evidence Intelligence consumer-side ownership of authoritative source-handling facts and of governed source-handling policy deciding processing, retention, reconstruction, access, and deletion; binding safety, historical/replay, and persistence invariants, with persistence rederiving every relevant handling decision rather than retention alone; all representation, lifecycle, identity, selection, category, audit, decoding, and test mechanics deferred to a separate design and implementation contract | Accepted; governed by ADPR-0008 (`APPROVED`); independent architecture audit returned `PASS` / `READY_FOR_ADR`; owner acceptance recorded 2026-08-14; PR #260 remains draft; no runtime implementation is authorized; no analytical authority is created and no `ANALYTICAL_AUTHORITY_REGISTRY` entry is required |
...
| Issue #287 | [ADPR-0009](architecture-records/ADPR-0009-evidence-intelligence-model-adapter.md) | proposed ADR 0034, not yet created | not yet created | Model Adapter architecture preparation is READY_FOR_REVIEW; no runtime provider integration authorized |
