...
def _contract_from_payload(payload: dict[str, Any]) -> MethodologyEvidenceInputContract:
    required_fields = (
        ...
        "exact_gap_free_non_overlapping_coverage_required",
        "allow_representation_boundary_crossing",
        "allow_pathway_boundary_crossing",
        "allow_supply_basis_boundary_crossing",
